...
class Arc:
    ...
    columns = ['name', 'start_date', 'start_time', 'start_round_time',
               'start_angle', 'start_angle_round', 'min_time', 'min_round_time',
               'min_angle', 'min_angle_round', 'end_time', 'end_round_time',
               'end_angle', 'end_angle_round', 'elapsed_time']
    name = None

    def info(self):
        return pd.Series([self.name, self.start_date, self.start_time, self.start_round_time,
                          self.start_angle, self.start_angle_round, self.min_time, self.min_round_time,
                          self.min_angle, self.min_angle_round, self.end_time, self.end_round_time,
    ...
    def __init__(self, arg_dict: dict):
        ...
        self.start_round_time = parser.parse(str(arg_dict['round_start'])).time()
        self.start_angle_round = time_to_degrees(self.start_round_time)
        ...
        self.min_round_time = parser.parse(str(arg_dict['round_min'])).time()
        self.min_angle_round = time_to_degrees(self.min_round_time)
        ...
        self.end_round_time = parser.parse(str(arg_dict['round_end'])).time()
        self.end_angle_round = time_to_degrees(self.end_round_time)
